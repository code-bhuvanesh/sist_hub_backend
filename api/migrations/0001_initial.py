    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('student', 'Student'), ('staff', 'Staff'), ('club', 'Club')], default='admin', max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postType', models.CharField(choices=[('general', 'General'), ('achivements', 'Achivements'), ('workshop', 'Workshop'), ('events', 'Events')], max_length=15)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('comments', models.ManyToManyField(blank=True, default=None, related_name='postComments', to=settings.AUTH_USER_MODEL)),
                ('likes', models.ManyToManyField(blank=True, default=None, related_name='postLikes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentComment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.postcomments')),
